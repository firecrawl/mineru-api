...
def _do_convert(pdf_bytes, lang, parse_method, formula_enable, table_enable, max_pages):
...
def convert_to_markdown(pdf_bytes, lang="en", parse_method="auto", formula_enable=True, table_enable=True, max_pages=None):
    ...
    try:
        return _do_convert(pdf_bytes, lang, parse_method, formula_enable, table_enable, max_pages)
        ...
        try:
            return _do_convert(repaired, lang, parse_method, formula_enable, table_enable, max_pages)
        except Exception:
            raise Exception(f"Error converting PDF to markdown: {first_error}")
